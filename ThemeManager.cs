...
public static class ThemeManager
{
    ...
    public static readonly Theme Light = new()
    {
        ...
        CanvasOuter = C("#E9ECEF"), CanvasBg = C("#FBFCFD"), GridLine = C("#E4E8EC"),
    ...
    public static readonly Theme Dark = new()
    {
        ...
        CanvasOuter = C("#14161B"), CanvasBg = C("#1E2229"), GridLine = C("#2A303A"),
    ...
    public static readonly Theme Slate = new()
    {
        ...
        CanvasOuter = C("#1D242E"), CanvasBg = C("#26303C"), GridLine = C("#33404F"),
    ...
    public static readonly Theme Sepia = new()
    {
        ...
        CanvasOuter = C("#EBE0CC"), CanvasBg = C("#F8F2E4"), GridLine = C("#E4D9C4"),
    ...
    static DrawingBrush MakeGridBrush(Color bg, Color line)
    {
        ...
        group.Children.Add(new GeometryDrawing(
            new SolidColorBrush(bg), null, new RectangleGeometry(new Rect(0, 0, 24, 24))));
        group.Children.Add(new GeometryDrawing(
            null, new Pen(new SolidColorBrush(line), 1), Geometry.Parse("M0,0 L24,0 M0,0 L0,24")));
